package dessert.chenxi.li.dessert_ui.dashboardView.view;
...
import dessert.chenxi.li.dessert_ui.dashboardView.util.PxUtils;
...
public class DashboardViewAttr {
    ...
    public DashboardViewAttr(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextSize = ta.getDimensionPixelSize(PxUtils.spToPx(R.styleable.DashboardView_android_textSize, context), 110);
        mText = ta.getString(R.styleable.DashboardView_android_text);
        progressStrokeWidth = (int) ta.getDimension(R.styleable.DashboardView_progressStrokeWidth, 50);
